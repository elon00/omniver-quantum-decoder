/**
 * Omniverse Quantum Decoder — URS Evidence Certificate Generator
...
console.log('╔══════════════════════════════════════════════════════════════════════════╗');
console.log('║   OMNIVERSE QUANTUM DECODER — URS EVIDENCE CERTIFICATE                   ║');
console.log('╚══════════════════════════════════════════════════════════════════════════╝\n');
...
run('npx tsx tests/nist-pqc.test.ts', '[1/3] Running Official NIST & Wycheproof Test Suite');
...
const certificatePayload = {
  protocol: 'Omniverse-Quantum-Decoder',
  ...
  truthTaxonomy: {
    ...
    shorQuantumEngine: 'PURE_MATHEMATICAL_NUMBER_THEORY',
    hardwareRunner: 'QISKIT_IBM_RUNTIME_GROVER_SEARCH',
